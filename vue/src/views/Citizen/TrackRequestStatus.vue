<template>
    <div class="md:grid-cols-3 md:gap-6 mt-12 ml-10 mr-10">
      <div class="md:col-span-1">
        <div class="px-4 sm:px-0">
          <h3 class="text-[40px] font-medium leading-6 text-gray-900 md:font-bold">Track Status</h3>
        ...
        <form @submit.prevent="trackVaccineStatus">  
          <div class="shadow sm:overflow-hidden sm:rounded-md">
            ...
            <div class="bg-gray-50 px-4 py-3 text-right sm:px-6">
              <button  type="submit" class="inline-flex justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 flex justify-between items-center mt-3">
  ...
  <div v-if="trackerLoading" class=" h-fit ">
    ...
    <template v-else>
  <div v-if="getallVaccinees < 1"></div>
  <div class="md:grid-cols-3 md:gap-6 mt-12 ml-10 mr-10" v-else>
    
    
    
    <h1 class="text-xl font-bold">Track result:</h1>
    ...
    <table class="w-full text-sm">
      <thead class=" text-left">
        ...
        <tbody>
          <template v-for="trackStatus in getallVaccinees">
            <tr v-if="trackStatus.reference_id === trackRequestStatus.reference_id">
            <td data-label="Name" class="pt-3 py-3">{{ trackStatus.firstname +"&nbsp"+  trackStatus.middlename +"&nbsp"+  trackStatus.lastname}}</td>
              ...
              <td>
                <button class="bg-red-400 text-white pl-7 pr-7 pt-3 pb-3" @click="opens(trackStatus.reference_id)" :value="trackStatus.reference_id">Download</button>
              </td>
            </tr>
          </template>
    ...
    <h1 class="text-xl font-bold">Other records:</h1>
